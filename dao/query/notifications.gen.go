...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.NotificationID = field.NewString(tableName, "notification_id")
	...
	_notification.RelatedEntityType = field.NewString(tableName, "related_entity_type")
	_notification.RelatedEntityID = field.NewString(tableName, "related_entity_id")
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.RelatedEntityType = field.NewString(table, "related_entity_type")
	n.RelatedEntityID = field.NewString(table, "related_entity_id")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["related_entity_type"] = n.RelatedEntityType
	n.fieldMap["related_entity_id"] = n.RelatedEntityID
