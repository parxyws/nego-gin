...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.AssignedAt = field.NewTime(tableName, "assigned_at")
	_rolePermission.AssignedBy = field.NewString(tableName, "assigned_by")
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.AssignedAt = field.NewTime(table, "assigned_at")
	r.AssignedBy = field.NewString(table, "assigned_by")
...
func (r *rolePermission) fillFieldMap() {
	...
	r.fieldMap["assigned_at"] = r.AssignedAt
