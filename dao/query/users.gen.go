...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.AccountStatus = field.NewString(tableName, "account_status")
	_user.IsVerified = field.NewTime(tableName, "is_verified")
	_user.VerificationToken = field.NewString(tableName, "verification_token")
...
func (u *user) updateTableName(table string) *user {
	...
	u.AccountStatus = field.NewString(table, "account_status")
	u.IsVerified = field.NewTime(table, "is_verified")
	u.VerificationToken = field.NewString(table, "verification_token")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["account_status"] = u.AccountStatus
	u.fieldMap["is_verified"] = u.IsVerified
	u.fieldMap["verification_token"] = u.VerificationToken
